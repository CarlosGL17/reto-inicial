...
<div>
        ...
        <div className='uk-container uk-container-large uk-visible@m'>
        ...
        <div className='uk-container uk-container-large uk-hidden@m'>
                <div className='uk-grid-large uk-margin-medium-top uk-flex uk-flex-middle uk-text-center' data-uk-grid>
                    <div className='uk-width-1-2@s'>
                        <div>
                            <LazyLoadImage src={Step1}></LazyLoadImage>
                        </div>
                    </div>
                    <div className='uk-width-1-2@s uk-text-left'>
                        <div className=''>
                    ...
                    <div className='uk-width-1-2@s'>
                        <div>
                            <LazyLoadImage src={Step2} ></LazyLoadImage>
                        </div>
                    </div>
                    <div className='uk-width-1-2@s uk-text-left'>
                        <div className=''>
                    ...
                    <div className='uk-width-1-2@s'>
                        <div>
                            <LazyLoadImage src={Step3}></LazyLoadImage>
                        </div>
                    </div>
                    <div className='uk-width-1-2@s uk-text-left'>
                        <div className=''>
